...
data class Exercise(var nom_exercise: String? = null, var url_video: String? = null, var time_count: String? = null, var jason: String? = null, var description: String? = null) {
