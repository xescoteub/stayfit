...
class BicepsExercises : AppCompatActivity() {
    ...
    fun controlListView(){
        ...
        var barbellCurl: Exercise = Exercise("Barbell Curl","https://www.youtube.com/watch?v=kwG2ipFRgfo", "0", "null", "Dumbbells allow the wrists to move freely, so most people adopt for a slight rotation of the wrist and forearm as they curl, which thickens the muscle group." )
        addExercise(barbellCurl)

        addExercise( Exercise("Chin-Up","https://www.youtube.com/watch?v=T78xCiw_R6g", "0", "null",""))
        ...
        addExercise( Exercise("Rope Hammer Curl","https://www.youtube.com/watch?v=_tg_GRzZiO4", "0", "null",""))
        //arrayList.add("Cable Rope Hammer Curl")
        addExercise( Exercise("Incline Dumbbell Curl","https://www.youtube.com/watch?v=b4jOP-spQW8", "0", "null",""))
        //arrayList.add("Incline Dumbbell Curl")
        addExercise( Exercise("Supinated / Reverse Grip Bent Over Row","https://www.youtube.com/watch?v=3gdGSSgDby8", "0", "null",""))
        //arrayList.add("Supinated / Reverse Grip Bent Over Row")
        addExercise( Exercise("Cable Curl","https://www.youtube.com/watch?v=85kXYq7Ssh4", "0", "null",""))
        ...
        addExercise( Exercise("EZ-Bar Curl","https://www.youtube.com/watch?v=kwG2ipFRgfo", "0", "null"," It engages both the short and long heads of the biceps muscle and for some people it's a lot more comfortable on the joints and forearms than a straight barbell"))
        //arrayList.add("EZ-Bar Curl")
        addExercise( Exercise("Overhead Cable Curl","https://www.youtube.com/watch?v=5_n3gVeGEqc", "0", "null","This is a great way to practice your front double biceps pose as you train. You can do both cables at once, or alternate between arms"))
        //arrayList.add("Overhead Cable Curl")
        addExercise( Exercise("Decline Dumbbell Curl","https://www.youtube.com/watch?v=OK6vpxXZ2pk&t=10s", "0", "null",""))
