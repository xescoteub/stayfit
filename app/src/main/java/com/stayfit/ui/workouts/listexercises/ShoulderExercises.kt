...
class ShoulderExercises : AppCompatActivity() {
    ...
    fun controlListView(){
        ...
        addExercise( Exercise("Front Raise","https://www.youtube.com/watch?v=-t7fuZ0KhDA", "0", "null",""))
        //arrayList.add("Front Raise")
        addExercise( Exercise("Reverse Pec Deck Fly","https://www.youtube.com/watch?time_continue=0&v=R63UajjKfnM&feature=emb_title", "0", "null",""))
        //arrayList.add("Reverse Pec Deck Fly")
        addExercise( Exercise("Bent-Over Dumbbell Lateral Raise","https://www.youtube.com/watch?v=ttvfGg9d76c&feature=emb_title", "0", "null",""))
        //arrayList.add("Bent-Over Dumbbell Lateral Raise")
        addExercise( Exercise("Dumbbell Lateral Raise","https://www.youtube.com/watch?v=-WEZj9ePTYI", "0", "null",""))
        //arrayList.add("Dumbbell Lateral Raise")
        addExercise( Exercise("Push Press","https://www.youtube.com/watch?v=iaBVSJm78ko", "0", "null",""))
        //arrayList.add("Push Press")
        addExercise( Exercise("Reverse Cable Crossover","https://www.youtube.com/watch?v=JENKmsEZQO8", "0", "null",""))
        //arrayList.add("Reverse Cable Crossover")
        addExercise( Exercise("One-Arm Cable Lateral Raise","https://www.youtube.com/watch?v=_w6ztKA4tO8", "0", "null",""))
        //arrayList.add("One-Arm Cable Lateral Raise")
        addExercise( Exercise("Standing Barbell Shrugs","https://www.youtube.com/watch?v=NAqCVe2mwzM", "0", "null",""))
