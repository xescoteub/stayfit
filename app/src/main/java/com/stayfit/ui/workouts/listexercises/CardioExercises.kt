...
class CardioExercises : AppCompatActivity() {
    ...
    fun controlListView(){
        var runningstairs: Exercise = Exercise("Running stairs", "https://www.youtube.com/watch?v=BvskUKjNAH8", "0", "null", "", "null")
        addExercise(runningstairs)

        addExercise( Exercise("Burpees","https://www.youtube.com/watch?v=TU8QYVW0gDU", "0", "null","", "null"))
        //arrayList.add("Burpees")
        addExercise( Exercise("Jump rope double-unders","https://www.youtube.com/watch?v=82jNjDS19lg", "0", "null","", "null"))
        //arrayList.add("Jump rope double-unders")
        addExercise( Exercise("Jump lunges","https://www.youtube.com/watch?v=hTdcOG9muQk", "0", "null","", "null"))
        //arrayList.add("Jump lunges")
        addExercise( Exercise("Mountain climbers","https://www.youtube.com/watch?v=zT-9L3CEcmk", "0", "null","", "null"))
        //arrayList.add("Mountain climbers")
        addExercise( Exercise("Jump squats","https://www.youtube.com/watch?v=Azl5tkCzDcc", "0", "null","", "null"))
        //arrayList.add("Jump squats")
        addExercise( Exercise("Speed skater lunge","https://www.youtube.com/watch?v=4RuxhVJ4-pg", "0", "null","", "null"))
        //arrayList.add("Speed skater lunge")
        addExercise( Exercise("Crab plank","https://www.youtube.com/watch?v=UDWNSnFy-VA", "0", "null","", "null"))
        //arrayList.add("Crab plank")
        addExercise( Exercise("Bicycle crunches","https://www.youtube.com/watch?v=9FGilxCbdz8", "0", "null","", "null"))
        //arrayList.add("Bicycle crunches")
        addExercise( Exercise("Jumping jacks","https://www.youtube.com/watch?v=c4DAnQ6DtF8", "0", "null","", "null"))
